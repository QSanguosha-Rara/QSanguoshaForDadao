...
bool Dashboard::CompareByNumber(const CardItem *a, const CardItem *b)  {
    return Card::CompareByNumber(a->getCard(), b->getCard());
}

bool Dashboard::CompareBySuit(const CardItem *a, const CardItem *b)  {
    return Card::CompareBySuit(a->getCard(), b->getCard());
}

bool Dashboard::CompareByType(const CardItem *a, const CardItem *b)  {
