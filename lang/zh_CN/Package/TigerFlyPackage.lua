return {
	...
	["xuanying"] = "玄影" ,
	[":xuanying"] = "回合开始时，你可以摸一张牌，然后选择一项：1.移动场上的一张牌；2.令一名角色获得一张移出游戏的牌；3.令一名角色获得另一名有手牌的角色的所有手牌，然后返回相同数量的手牌。最后结束此回合。" ,
	...
	["@xuanying-discardpile"] = "请选择一名拥有移出游戏牌的角色" ,
	["@xuanying-discardpile2"] = "请选择获得该移出游戏牌的角色。" ,
